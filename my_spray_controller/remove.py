...
class LeafWallLidarNode(Node):
    ...
    def __init__(self):
        ...
        self.lidar_nozzle_offset = 1.58  # Meter distance from LiDAR to nozzles
    ...
    def scan_callback(self, msg: LaserScan):
        ...
        if self.distance_traveled - self.last_grid_publish_distance >= self.grid_length:
            ...
            self.get_logger().info(f"Grid calculated at {self.distance_traveled:.2f}m, will publish when nozzles reach {target_distance:.2f}m")
    ...
    def publish_delayed_grid_densities(self, grid_data):
        ...
        # self.get_logger().info(f"----------------Delayed Grid Densities: {grid_data}------------")
